 ...
 */
export const YARN_RC_WORKSPACE_TOOLS_PATH = path.join('.yarn', 'plugins', '@yarnpkg', 'plugin-workspace-tools.cjs');

/**
 * 실제 Yarn Workspace Since Plugin의 경로
 */
export const YARN_WORKSPACE_TOOLS_RELEASE_FILE_PATH = path.resolve(__dirname, '..', YARN_RC_WORKSPACE_TOOLS_PATH);